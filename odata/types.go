...
const (
	...
	ShortTypeDeviceManagementConfigurationChoiceSettingDefinition           ShortType = "deviceManagementConfigurationChoiceSettingDefinition"
	ShortTypeDeviceManagementConfigurationSimpleSettingDefinition           ShortType = "deviceManagementConfigurationSimpleSettingDefinition"
	ShortTypeDeviceManagementConfigurationSimpleSettingCollectionDefinition ShortType = "deviceManagementConfigurationSimpleSettingCollectionDefinition"
	ShortTypeDeviceManagementConfigurationSettingGroupCollectionDefinition  ShortType = "deviceManagementConfigurationSettingGroupCollectionDefinition"
	ShortTypeDeviceManagementConfigurationChoiceSettingCollectionDefinition ShortType = "deviceManagementConfigurationChoiceSettingCollectionDefinition"
	ShortTypeDeviceManagementConfigurationRedirectSettingDefinition         ShortType = "deviceManagementConfigurationRedirectSettingDefinition"
	ShortTypeDeviceManagementConfigurationSimpleSettingValue                ShortType = "deviceManagementConfigurationSimpleSettingValue"
	ShortTypeDeviceManagementConfigurationIntegerSettingValue               ShortType = "deviceManagementConfigurationIntegerSettingValue"
)
...
const (
	...
	TypeDeviceManagementConfigurationChoiceSettingDefinition           Type = "#microsoft.graph.deviceManagementConfigurationChoiceSettingDefinition"
	TypeDeviceManagementConfigurationSimpleSettingDefinition           Type = "#microsoft.graph.deviceManagementConfigurationSimpleSettingDefinition"
	TypeDeviceManagementConfigurationSimpleSettingCollectionDefinition Type = "#microsoft.graph.deviceManagementConfigurationSimpleSettingCollectionDefinition"
	TypeDeviceManagementConfigurationSettingGroupCollectionDefinition  Type = "#microsoft.graph.deviceManagementConfigurationSettingGroupCollectionDefinition"
	TypeDeviceManagementConfigurationChoiceSettingCollectionDefinition Type = "#microsoft.graph.deviceManagementConfigurationChoiceSettingCollectionDefinition"
	TypeDeviceManagementConfigurationRedirectSettingDefinition         Type = "#microsoft.graph.deviceManagementConfigurationRedirectSettingDefinition"
	TypeDeviceManagementConfigurationSimpleSettingValue                Type = "#microsoft.graph.deviceManagementConfigurationSimpleSettingValue"
	TypeDeviceManagementConfigurationIntegerSettingValue                Type = "#microsoft.graph.deviceManagementConfigurationIntegerSettingValue"
)
